...
use work.spwm_data_controller_pkg.all;       -- For routing_table_t, if still needed

entity spwm_data_controller_ent is
    port(
        -- Clock/Reset
        clk_i                      : in  std_logic;
        rst_i                      : in  std_logic;
...
end spwm_data_controller_ent;

architecture RTL of spwm_data_controller_ent is
