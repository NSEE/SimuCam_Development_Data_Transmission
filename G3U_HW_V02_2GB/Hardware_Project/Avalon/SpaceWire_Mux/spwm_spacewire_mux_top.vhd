...
begin
    ...
    spwm_data_controller_ent_ch1_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
    ...
    spwm_data_controller_ent_ch2_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
        ...
        spwm_data_controller_ent_ch3_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_data_controller_ent_ch4_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_data_controller_ent_ch5_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_data_controller_ent_ch6_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_data_controller_ent_ch7_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_data_controller_ent_ch8_inst : entity work.spwm_data_controller_ent
        port map(
            clk_i                      => a_spw_clock,
            rst_i                      => a_reset,
            spw_router_routing_table_i => spw_router_routing_table,
    ...
    spwm_crossbar_switch_ent_inst : entity work.spwm_crossbar_switch_ent
        generic map(
            g_RESET_DELAY         => 2,
    ...
    spwm_data_arbiter_ent_ch1_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch2_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
        ...
        spwm_data_arbiter_ent_ch3_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch4_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch5_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch6_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch7_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spwm_data_arbiter_ent_ch8_inst : entity work.spwm_data_arbiter_ent
        generic map(
            g_RESET_DELAY         => 2,
            g_SPW_ROUTER_CHANNELS => c_SPW_ROUTER_CHANNELS
        )
    ...
    spw_ch1_link_command_linkstart_o   <= '1';
    ...
    spw_ch2_link_command_linkstart_o   <= '1';
    ...
    spw_ch3_link_command_linkstart_o   <= '1';
    ...
    spw_ch4_link_command_linkstart_o   <= '1';
    ...
    spw_ch5_link_command_linkstart_o   <= '1';
    ...
    spw_ch6_link_command_linkstart_o   <= '1';
    ...
    spw_ch7_link_command_linkstart_o   <= '1';
    ...
    spw_ch8_link_command_linkstart_o   <= '1';
