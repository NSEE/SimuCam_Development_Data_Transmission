...
#define DCOM_CH_5_BASE_ADDR              DUMB_COMMUNICATION_MODULE_V2_1_BASE
#define DCOM_CH_6_BASE_ADDR              DUMB_COMMUNICATION_MODULE_V2_2_BASE
#define DCOM_CH_7_BASE_ADDR              DUMB_COMMUNICATION_MODULE_V2_3_BASE
#define DCOM_CH_8_BASE_ADDR              DUMB_COMMUNICATION_MODULE_V2_4_BASE
#define DCOM_RMAP_MEM_1_BASE_ADDR        0
#define DCOM_RMAP_MEM_2_BASE_ADDR        0
#define DCOM_RMAP_MEM_3_BASE_ADDR        0
#define DCOM_RMAP_MEM_4_BASE_ADDR        0
#define DCOM_RMAP_MEM_5_BASE_ADDR        0
#define DCOM_RMAP_MEM_6_BASE_ADDR        0
#define DCOM_RMAP_MEM_7_BASE_ADDR        0
#define DCOM_RMAP_MEM_8_BASE_ADDR        0
