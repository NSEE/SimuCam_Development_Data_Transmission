...
bool bIdmaInitCh1Dma(void) {
	...
	/* start new transfer */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrLowDword = DDR2_BASE_ADDR_DATASET_1;
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrHighDword = DDR2_M1_MEMORY_BASE;
	/* HW use zero as reference for transfer size, need to decrement one word from the total transfer size */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdDataLenghtBytes = DSCH_DATA_ACCESS_WIDTH_BYTES;
	vpxDcomChannel->xDataScheduler.xDschDataControl.bRdStart = FALSE;
	bStatus = TRUE;
	return bStatus;
}
...
bool bIdmaInitCh2Dma(void) {
	...
	/* start new transfer */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrLowDword = DDR2_BASE_ADDR_DATASET_2;
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrHighDword = DDR2_M1_MEMORY_BASE;
	/* HW use zero as reference for transfer size, need to decrement one word from the total transfer size */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdDataLenghtBytes = DSCH_DATA_ACCESS_WIDTH_BYTES;
	vpxDcomChannel->xDataScheduler.xDschDataControl.bRdStart = FALSE;
...
bool bIdmaInitCh3Dma(void) {
	...
	/* start new transfer */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrLowDword = DDR2_BASE_ADDR_DATASET_3;
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrHighDword = DDR2_M1_MEMORY_BASE;
	/* HW use zero as reference for transfer size, need to decrement one word from the total transfer size */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdDataLenghtBytes = DSCH_DATA_ACCESS_WIDTH_BYTES;
	vpxDcomChannel->xDataScheduler.xDschDataControl.bRdStart = FALSE;
...
bool bIdmaInitCh4Dma(void) {
	...
	/* start new transfer */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrLowDword = DDR2_BASE_ADDR_DATASET_4;
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrHighDword = DDR2_M1_MEMORY_BASE;
	/* HW use zero as reference for transfer size, need to decrement one word from the total transfer size */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdDataLenghtBytes = DSCH_DATA_ACCESS_WIDTH_BYTES;
	vpxDcomChannel->xDataScheduler.xDschDataControl.bRdStart = FALSE;
...
bool bIdmaInitCh5Dma(void) {
	...
	/* start new transfer */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrLowDword = DDR2_BASE_ADDR_DATASET_1;
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdInitAddrHighDword = DDR2_M2_MEMORY_BASE;
	/* HW use zero as reference for transfer size, need to decrement one word from the total transfer size */
	vpxDcomChannel->xDataScheduler.xDschDataControl.uliRdDataLenghtBytes = DSCH_DATA_ACCESS_WIDTH_BYTES;
	vpxDcomChannel->xDataScheduler.xDschDataControl.bRdStart = FALSE;
	bStatus = TRUE;
