...
begin
    ...
    spw_link_command_enable_o      <= ('0') when (a_reset = '1')
                                      else (spw_ch0_link_command_enable_i) when (mux_select_i = c_MUX_SELECTED_CH_0)
                                      else (spw_ch1_link_command_enable_i) when (mux_select_i = c_MUX_SELECTED_CH_1)
                                      else ('0');
