...
module MebX_Qsys_Project_mm_interconnect_0 (
	...
	wire  [361:0] m2_ddr2_memory_avl_agent_rf_source_data;                                                       // m2_ddr2_memory_avl_agent:rf_source_data -> m2_ddr2_memory_avl_agent_rsp_fifo:in_data
	...
	wire  [361:0] m2_ddr2_memory_avl_agent_rsp_fifo_out_data;                                                    // m2_ddr2_memory_avl_agent_rsp_fifo:out_data -> m2_ddr2_memory_avl_agent:rf_sink_data
	...
	wire  [361:0] m1_clock_bridge_s0_agent_rf_source_data;                                                       // m1_clock_bridge_s0_agent:rf_source_data -> m1_clock_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [361:0] m1_clock_bridge_s0_agent_rsp_fifo_out_data;                                                    // m1_clock_bridge_s0_agent_rsp_fifo:out_data -> m1_clock_bridge_s0_agent:rf_sink_data
	...
	wire  [108:0] ddr2_address_span_extender_expanded_master_agent_cp_data;                                      // ddr2_address_span_extender_expanded_master_agent:cp_data -> router:sink_data
	...
	wire          m2_ddr2_memory_avl_agent_rp_valid;                                                             // m2_ddr2_memory_avl_agent:rp_valid -> router_001:sink_valid
	wire  [360:0] m2_ddr2_memory_avl_agent_rp_data;                                                              // m2_ddr2_memory_avl_agent:rp_data -> router_001:sink_data
	wire          m2_ddr2_memory_avl_agent_rp_ready;                                                             // router_001:sink_ready -> m2_ddr2_memory_avl_agent:rp_ready
	wire          m2_ddr2_memory_avl_agent_rp_startofpacket;                                                     // m2_ddr2_memory_avl_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          m2_ddr2_memory_avl_agent_rp_endofpacket;                                                       // m2_ddr2_memory_avl_agent:rp_endofpacket -> router_001:sink_endofpacket
	wire          m1_clock_bridge_s0_agent_rp_valid;                                                             // m1_clock_bridge_s0_agent:rp_valid -> router_002:sink_valid
	wire  [360:0] m1_clock_bridge_s0_agent_rp_data;                                                              // m1_clock_bridge_s0_agent:rp_data -> router_002:sink_data
	wire          m1_clock_bridge_s0_agent_rp_ready;                                                             // router_002:sink_ready -> m1_clock_bridge_s0_agent:rp_ready
	wire          m1_clock_bridge_s0_agent_rp_startofpacket;                                                     // m1_clock_bridge_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          m1_clock_bridge_s0_agent_rp_endofpacket;                                                       // m1_clock_bridge_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          router_src_valid;                                                                              // router:src_valid -> ddr2_address_span_extender_expanded_master_limiter:cmd_sink_valid
	wire  [108:0] router_src_data;                                                                               // router:src_data -> ddr2_address_span_extender_expanded_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                              // ddr2_address_span_extender_expanded_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                            // router:src_channel -> ddr2_address_span_extender_expanded_master_limiter:cmd_sink_channel
	...
	wire  [108:0] ddr2_address_span_extender_expanded_master_limiter_cmd_src_data;                               // ddr2_address_span_extender_expanded_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [1:0] ddr2_address_span_extender_expanded_master_limiter_cmd_src_channel;                            // ddr2_address_span_extender_expanded_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [108:0] rsp_mux_src_data;                                                                              // rsp_mux:src_data -> ddr2_address_span_extender_expanded_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                             // ddr2_address_span_extender_expanded_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                           // rsp_mux:src_channel -> ddr2_address_span_extender_expanded_master_limiter:rsp_sink_channel
	...
	wire  [108:0] ddr2_address_span_extender_expanded_master_limiter_rsp_src_data;                               // ddr2_address_span_extender_expanded_master_limiter:rsp_src_data -> ddr2_address_span_extender_expanded_master_agent:rp_data
	...
	wire    [1:0] ddr2_address_span_extender_expanded_master_limiter_rsp_src_channel;                            // ddr2_address_span_extender_expanded_master_limiter:rsp_src_channel -> ddr2_address_span_extender_expanded_master_agent:rp_channel
	...
	wire  [360:0] m2_ddr2_memory_avl_burst_adapter_source0_data;                                                 // m2_ddr2_memory_avl_burst_adapter:source0_data -> m2_ddr2_memory_avl_agent:cp_data
	...
	wire    [1:0] m2_ddr2_memory_avl_burst_adapter_source0_channel;                                              // m2_ddr2_memory_avl_burst_adapter:source0_channel -> m2_ddr2_memory_avl_agent:cp_channel
	...
	wire  [360:0] m1_clock_bridge_s0_burst_adapter_source0_data;                                                 // m1_clock_bridge_s0_burst_adapter:source0_data -> m1_clock_bridge_s0_agent:cp_data
	...
	wire    [1:0] m1_clock_bridge_s0_burst_adapter_source0_channel;                                              // m1_clock_bridge_s0_burst_adapter:source0_channel -> m1_clock_bridge_s0_agent:cp_channel
	...
	wire          router_001_src_valid;                                                                          // router_001:src_valid -> m2_ddr2_memory_avl_rsp_width_adapter:in_valid
	wire  [360:0] router_001_src_data;                                                                           // router_001:src_data -> m2_ddr2_memory_avl_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                                          // m2_ddr2_memory_avl_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                                        // router_001:src_channel -> m2_ddr2_memory_avl_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                                  // router_001:src_startofpacket -> m2_ddr2_memory_avl_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                                    // router_001:src_endofpacket -> m2_ddr2_memory_avl_rsp_width_adapter:in_endofpacket
	wire          m2_ddr2_memory_avl_rsp_width_adapter_src_valid;                                                // m2_ddr2_memory_avl_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [108:0] m2_ddr2_memory_avl_rsp_width_adapter_src_data;                                                 // m2_ddr2_memory_avl_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          m2_ddr2_memory_avl_rsp_width_adapter_src_ready;                                                // rsp_demux:sink_ready -> m2_ddr2_memory_avl_rsp_width_adapter:out_ready
	wire    [1:0] m2_ddr2_memory_avl_rsp_width_adapter_src_channel;                                              // m2_ddr2_memory_avl_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire          router_002_src_valid;                                                                          // router_002:src_valid -> m1_clock_bridge_s0_rsp_width_adapter:in_valid
	wire  [360:0] router_002_src_data;                                                                           // router_002:src_data -> m1_clock_bridge_s0_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                                          // m1_clock_bridge_s0_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                                                        // router_002:src_channel -> m1_clock_bridge_s0_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                                  // router_002:src_startofpacket -> m1_clock_bridge_s0_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                                    // router_002:src_endofpacket -> m1_clock_bridge_s0_rsp_width_adapter:in_endofpacket
	wire          m1_clock_bridge_s0_rsp_width_adapter_src_valid;                                                // m1_clock_bridge_s0_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [108:0] m1_clock_bridge_s0_rsp_width_adapter_src_data;                                                 // m1_clock_bridge_s0_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          m1_clock_bridge_s0_rsp_width_adapter_src_ready;                                                // rsp_demux_001:sink_ready -> m1_clock_bridge_s0_rsp_width_adapter:out_ready
	wire    [1:0] m1_clock_bridge_s0_rsp_width_adapter_src_channel;                                              // m1_clock_bridge_s0_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          m1_clock_bridge_s0_rsp_width_adapter_src_startofpacket;                                        // m1_clock_bridge_s0_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          m1_clock_bridge_s0_rsp_width_adapter_src_endofpacket;                                          // m1_clock_bridge_s0_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_src_valid;                                                                             // cmd_mux:src_valid -> m2_ddr2_memory_avl_cmd_width_adapter:in_valid
	wire  [108:0] cmd_mux_src_data;                                                                              // cmd_mux:src_data -> m2_ddr2_memory_avl_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                             // m2_ddr2_memory_avl_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                                           // cmd_mux:src_channel -> m2_ddr2_memory_avl_cmd_width_adapter:in_channel
	...
	wire  [360:0] m2_ddr2_memory_avl_cmd_width_adapter_src_data;                                                 // m2_ddr2_memory_avl_cmd_width_adapter:out_data -> m2_ddr2_memory_avl_burst_adapter:sink0_data
	...
	wire    [1:0] m2_ddr2_memory_avl_cmd_width_adapter_src_channel;                                              // m2_ddr2_memory_avl_cmd_width_adapter:out_channel -> m2_ddr2_memory_avl_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                                                         // cmd_mux_001:src_valid -> m1_clock_bridge_s0_cmd_width_adapter:in_valid
	wire  [108:0] cmd_mux_001_src_data;                                                                          // cmd_mux_001:src_data -> m1_clock_bridge_s0_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                                         // m1_clock_bridge_s0_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                                       // cmd_mux_001:src_channel -> m1_clock_bridge_s0_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                                                 // cmd_mux_001:src_startofpacket -> m1_clock_bridge_s0_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                                   // cmd_mux_001:src_endofpacket -> m1_clock_bridge_s0_cmd_width_adapter:in_endofpacket
	wire          m1_clock_bridge_s0_cmd_width_adapter_src_valid;                                                // m1_clock_bridge_s0_cmd_width_adapter:out_valid -> m1_clock_bridge_s0_burst_adapter:sink0_valid
	wire  [360:0] m1_clock_bridge_s0_cmd_width_adapter_src_data;                                                 // m1_clock_bridge_s0_cmd_width_adapter:out_data -> m1_clock_bridge_s0_burst_adapter:sink0_data
	wire          m1_clock_bridge_s0_cmd_width_adapter_src_ready;                                                // m1_clock_bridge_s0_burst_adapter:sink0_ready -> m1_clock_bridge_s0_cmd_width_adapter:out_ready
	wire    [1:0] m1_clock_bridge_s0_cmd_width_adapter_src_channel;                                              // m1_clock_bridge_s0_cmd_width_adapter:out_channel -> m1_clock_bridge_s0_burst_adapter:sink0_channel
	wire          m1_clock_bridge_s0_cmd_width_adapter_src_startofpacket;                                        // m1_clock_bridge_s0_cmd_width_adapter:out_startofpacket -> m1_clock_bridge_s0_burst_adapter:sink0_startofpacket
	wire          m1_clock_bridge_s0_cmd_width_adapter_src_endofpacket;                                          // m1_clock_bridge_s0_cmd_width_adapter:out_endofpacket -> m1_clock_bridge_s0_burst_adapter:sink0_endofpacket
	...
	wire  [108:0] rsp_demux_001_src0_data;                                                                       // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [108:0] crosser_003_out_data;                                                                          // crosser_003:out_data -> rsp_mux:sink1_data
	...
	wire    [1:0] ddr2_address_span_extender_expanded_master_limiter_cmd_valid_data;                             // ddr2_address_span_extender_expanded_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	altera_merlin_burst_adapter #(
		...
		.sink0_valid           (m1_clock_bridge_s0_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (m1_clock_bridge_s0_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (m1_clock_bridge_s0_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (m1_clock_bridge_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (m1_clock_bridge_s0_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (m1_clock_bridge_s0_cmd_width_adapter_src_ready),         //          .ready
	...
	MebX_Qsys_Project_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (m2_ddr2_memory_afi_half_clk_clk),                        //       clk.clk
		.reset              (m1_clock_bridge_s0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.sink_ready         (m1_clock_bridge_s0_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (m1_clock_bridge_s0_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (m1_clock_bridge_s0_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (m1_clock_bridge_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (m1_clock_bridge_s0_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (m1_clock_bridge_s0_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) m1_clock_bridge_s0_rsp_width_adapter (
		.clk                  (m2_ddr2_memory_afi_half_clk_clk),                        //       clk.clk
		.reset                (m1_clock_bridge_s0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		...
		.out_endofpacket      (m1_clock_bridge_s0_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (m1_clock_bridge_s0_rsp_width_adapter_src_data),          //          .data
		.out_channel          (m1_clock_bridge_s0_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (m1_clock_bridge_s0_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (m1_clock_bridge_s0_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (m1_clock_bridge_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                  // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) m1_clock_bridge_s0_cmd_width_adapter (
		.clk                  (m2_ddr2_memory_afi_half_clk_clk),                        //       clk.clk
		.reset                (m1_clock_bridge_s0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		...
		.out_endofpacket      (m1_clock_bridge_s0_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (m1_clock_bridge_s0_cmd_width_adapter_src_data),          //          .data
		.out_channel          (m1_clock_bridge_s0_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (m1_clock_bridge_s0_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (m1_clock_bridge_s0_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (m1_clock_bridge_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                  // (terminated)
	);
