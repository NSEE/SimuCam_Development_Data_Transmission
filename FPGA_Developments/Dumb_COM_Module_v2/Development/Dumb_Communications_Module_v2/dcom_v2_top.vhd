...
begin
    ...
    data_controller_ent_inst : entity work.data_controller_ent
        ...
        port map(
            ...
            tmr_stop_i          => s_dcom_write_registers.data_scheduler_tmr_control_reg.timer_stop,
            tmr_start_i         => s_dcom_write_registers.data_scheduler_tmr_control_reg.timer_start,
            timeout_ticks_i     => s_dcom_write_registers.data_scheduler_timeout_config_reg.timeout_ticks,
            timeout_clear_i     => (s_dcom_write_registers.data_scheduler_timeout_config_reg.timeout_clear or s_dcom_write_registers.data_scheduler_tmr_control_reg.timer_clear),
            ...
            dctrl_timeout_flag_o => s_dcom_read_registers.data_scheduler_timeout_status_reg.timeout_flag,
    ...
    data_scheduler_ent_inst : entity work.data_scheduler_ent
        ...
        port map(
            ...
            sync_ignore_i     => s_dcom_write_registers.data_scheduler_sync_config_reg.sync_control,
